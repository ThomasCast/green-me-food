...
product1 = Product.create(name:"Melon", price: 3, photo_url:"https://unsplash.com/photos/ObRAfM60HQ0", description:"C'est du bon melon de Marcel sa mère.",category_id: cat1.id, producer_id: producer1.id)
product2 = Product.create(name:"Savon de Marseille", price: 7, photo_url:"https://unsplash.com/photos/vS_piUP3iHE", description:"Le savon pour qui vous fera une peau de bébé.",category_id: cat2.id,  producer_id: producer2.id)
product3 = Product.create(name:"Fraises", price: 4.30, photo_url:"https://unsplash.com/photos/Xiid7kYq4Jc", description:"Fraises de Carpentras, les meilleures du mondes.",category_id: cat3.id, producer_id: producer3.id)
product4 = Product.create(name:"Banon", price: 8, photo_url:"https://unsplash.com/photos/v9deD75EaRw", description:"Fromage de chèvre à pate molle, essentiellemnt produit à Banon.",category_id: cat4.id, producer_id: producer4.id)
product5 = Product.create(name:"Lavande", price: 12, photo_url:"https://unsplash.com/photos/2kptDvAfDjE", description:"Lavande de provence, parfum doux et subtile à la foie.",category_id: cat5.id, producer_id: producer5.id)
