...
product1 = Product.create(name:"Melon", price: 3, photo_url:"https://images.unsplash.com/photo-1598533834006-7679b2aea830?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=802&q=80", description:"C'est du bon melon de Marcel sa mère.", producer_id: producer1)
product2 = Product.create(name:"Savon de Marseille", price: 7, photo_url:"https://images.unsplash.com/photo-1572527226808-051d3c05e7a1?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80", description:"Le savon pour qui vous fera une peau de bébé.",  producer_id: producer2)
product3 = Product.create(name:"Fraises", price: 4.30, photo_url:"https://images.unsplash.com/photo-1590831701857-a2d4a8921353?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80", description:"Fraises de Carpentras, les meilleures du mondes.", producer_id: producer3)
product4 = Product.create(name:"Banon", price: 8, photo_url:"https://images.unsplash.com/photo-1604323225010-1a38a5dee780?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80", description:"Fromage de chèvre à pate molle, essentiellemnt produit à Banon.", producer_id: producer4)
product5 = Product.create(name:"Lavande", price: 12, photo_url:"https://images.unsplash.com/photo-1580986584724-ae79be2aae43?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1510&q=80", description:"Lavande de provence, parfum doux et subtile à la foie.", producer_id: producer5)
...
cat6 = Category.create(name: "Hygiène et Beauté", group: "Hygiène", photo_url: "https://images.unsplash.com/photo-1590439471364-192aa70c0b53?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80")
cat7 = Category.create(name: "Entretien et Netoyage", group: "Produits ménagers", photo_url: "https://images.unsplash.com/photo-1583907659441-addbe699e921?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Y2xlYW5pbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
cat8 = Category.create(name: "Epicerie salé", group: "Epicerie", photo_url: "https://images.unsplash.com/photo-1551462147-ff29053bfc14?ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8cGFzdGF8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
cat9 = Category.create(name: "Epicerie sucré", group: "Epicerie", photo_url: "https://images.unsplash.com/photo-1610450949065-1f2841536c88?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Y2hvY29sYXRlfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
